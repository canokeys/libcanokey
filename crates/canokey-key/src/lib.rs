...
/// RSA modulus width in bytes, or None for a non-RSA algorithm.
pub fn rsa_len(algorithm: Algorithm) -> Option<usize> {
    match algorithm {
...
/// Short-Weierstrass coordinate width, or None for other algorithms.
pub fn curve_len(algorithm: Algorithm) -> Option<usize> {
    match algorithm {
